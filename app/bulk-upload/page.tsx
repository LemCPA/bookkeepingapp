...
export default function BulkUploadPage() {
    ...
    reader.onload = (e) => {
      try {
        ...
        for (let i = 1; i < lines.length; i++) {
          ...
          if (!row.client_name) errors.push('Missing client name')
  ...
  const handleBulkDocumentAnalysis = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/bulk-scan-documents', {
        method: 'POST',
        body: formData,
      })
      ...
      setImportStatus('error')
      setErrorMessage(`Analysis error: ${error}`)
    }
  }
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Upload multiple transactions via CSV or scan multiple documents at once
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <div className="text-3xl mb-2">📄</div>
              <h3 className="font-bold text-lg">Bulk Scan Documents</h3>
              <p className="text-sm text-gray-600 mt-1">Scan multiple receipts and invoices</p>
            </button>
          </div>
        </div>
        ...
        {uploadMode === 'csv' && (
          <div className="bg-white rounded-lg shadow p-8">
            ...
            <div className="mb-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <button
                onClick={() => {
                  const template = 'client_name,transaction_date,amount,description,type,reference_number,gst_hst_rate\n' +
                    'Acme Corp,2026-05-10,1500.00,Consulting Services,INVOICE,INV-001,5\n' +
                    'Office Supplies Inc,2026-05-11,250.00,Paper and Pens,RECEIPT,REC-001,13'
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <ul className="mt-2 space-y-1 text-gray-600">
                    <li>• <code className="bg-white px-2 py-1 rounded">client_name</code> - Client name</li>
        ...
        {uploadMode === 'documents' && (
          <div className="bg-white rounded-lg shadow p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Bulk Scan Documents</h2>
            ...
            <div className="mb-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <ol className="space-y-2 text-sm text-blue-800">
                <li className="flex items-start gap-3">
                  ...
                  <span>Select one or more receipts, invoices, or bills (PDF, JPG, PNG)</span>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>Review extracted data and import in bulk</span>
                </li>
              </ol>
            </div>
