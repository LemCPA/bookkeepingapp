...
export default function APAgingPage() {
  ...
  async function fetchAPAgingReport() {
    ...
    try {
      const response = await fetch(
        `/api/reports/ap-aging?clientId=${selectedClient}&asOfDate=${asOfDate}`
      )
  ...
  async function fetchVendorDetail(vendorName: string) {
    ...
    try {
      const response = await fetch(
        `/api/reports/ap-aging?clientId=${selectedClient}&asOfDate=${asOfDate}&vendorName=${encodeURIComponent(vendorName)}`
      )
