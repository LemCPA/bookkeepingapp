    ...
    async function checkAccess() {
      try {
        ...
        if (response.ok) {
          ...
          setHasAccess(canAccessReport('home-expenses', data.plan || 'free'))
        }
      } catch (err) {
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-2xl mx-auto px-6 py-20">
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Home Expenses Report is available on Starter and Growth plans.</p>
