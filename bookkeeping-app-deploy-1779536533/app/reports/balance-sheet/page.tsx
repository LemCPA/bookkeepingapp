          ...
          <div className="lg:col-span-3">
            {!data ? (
              <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-12 text-center">
                <h2 className="text-2xl font-bold text-blue-900 mb-3">Ready to Generate Report</h2>
                <p className="text-blue-800 text-lg">
                  Select a client and month on the left, then click <strong>"Generate Report"</strong> to view your balance sheet.
                </p>
              </div>
            ) : (
